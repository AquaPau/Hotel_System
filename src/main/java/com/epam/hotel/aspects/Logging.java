...
public class Logging {
    ...
    public void logBeforeCreate(JoinPoint joinPoint) {
        Logging.log.info(joinPoint.getTarget().getClass().getSimpleName() + joinPoint.getSignature().getName());
    }

    @AfterReturning(pointcut = "allCreateMethods()", returning = "value")
    public void logAfterCreate(Object value) {
        if (value != null) { Logging.log.info("Added " + value.getClass().getSimpleName() + " to database"); }
    }
    ...
    public void logAfterUpdate(Object value) {
        if (value != null && value.toString().toUpperCase().equals("TRUE")) { Logging.log.info("Updated entity in database"); }
    }
    ...
    public void logAfterDelete(Object value) {
        if (value != null && value.toString().toUpperCase().equals("TRUE")) { Logging.log.info("Deleted entity in database"); }
    }
    ...
    public void logAfterGetAll(Object value) {
        if (value != null) { Logging.log.info("Retrieved a list"); }
    }
    ...
    public void logAfterGetById(Object value) {
        Logging.log.info("Accessed " + value.getClass().getSimpleName() + " from a database by id");
    }
